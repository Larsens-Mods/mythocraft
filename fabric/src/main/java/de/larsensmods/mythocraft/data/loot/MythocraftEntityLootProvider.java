...
public class MythocraftEntityLootProvider extends SimpleFabricLootTableProvider {
    ...
    public void generate(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> output) {
        ...
        output.accept(MythocraftLootTables.BLACKSMITH_CYCLOPS_LOOT, BlacksmithCyclopsEntity.getLootTableBuilder());
        output.accept(MythocraftLootTables.MINOTAUR_LOOT, MinotaurEntity.getLootTableBuilder());
    }
}
