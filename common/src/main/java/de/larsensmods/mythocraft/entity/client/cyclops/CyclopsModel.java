...
public class CyclopsModel<T extends CyclopsEntity> extends HierarchicalModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Constants.MOD_ID, "cyclops"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(0, 21).addBox(-9.0F, -2.0F, -6.0F, 18.0F, 17.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -7.0F, 0.0F));
        ...
        PartDefinition right_arm = body.addOrReplaceChild("right_arm", CubeListBuilder.create().texOffs(58, 23).addBox(-4.0F, -3.0F, -3.0F, 4.0F, 20.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(-9.0F, 1.0F, -1.0F));

        PartDefinition left_arm = body.addOrReplaceChild("left_arm", CubeListBuilder.create().texOffs(78, 23).addBox(0.0F, -2.8257F, -3.0076F, 4.0F, 20.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offset(9.0F, 1.0F, -1.0F));
    ...
    @Override
    public void setupAnim(@NotNull CyclopsEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
