...
public class SatyrAnimations {

    public static final AnimationDefinition ANIM_SATYR_IDLE = AnimationDefinition.Builder.withLength(3.0F).looping()
            ...
            .addAnimation("RightArm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(1.5F, KeyframeAnimations.degreeVec(-7.5F, 0.0F, 5.0F), AnimationChannel.Interpolations.LINEAR),
                    new Keyframe(2.25F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 2.5F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(3.0F, KeyframeAnimations.degreeVec(7.5F, 0.0F, 5.0F), AnimationChannel.Interpolations.LINEAR)
            ))
    ...
    public static final AnimationDefinition ANIM_SATYR_WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("RightArm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    ...
                    new Keyframe(2.0F, KeyframeAnimations.degreeVec(25.0F, 0.0F, 2.5F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            .addAnimation("LeftArm", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-25.0F, 0.0F, -2.5F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.degreeVec(25.0F, 0.0F, -2.5F), AnimationChannel.Interpolations.CATMULLROM),
