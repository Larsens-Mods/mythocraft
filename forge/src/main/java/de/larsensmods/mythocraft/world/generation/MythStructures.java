...
public class MythStructures {
    ...
    public static void bootstrap(BootstapContext<Structure> structureBootstapContext) {
        HolderGetter<Biome> biomeHolderGetter = structureBootstapContext.lookup(Registries.BIOME);
        HolderGetter<StructureTemplatePool> structureTemplatePoolHolderGetter = structureBootstapContext.lookup(Registries.TEMPLATE_POOL);

        structureBootstapContext.register(MythocraftStructures.GREEK_TEMPLE, new JigsawStructure(
        ...
        structureBootstapContext.register(MythocraftStructures.CYCLOPS_CAVE, new JigsawStructure(
                new Structure.StructureSettings(
        ...
        structureBootstapContext.register(MythocraftStructures.CYCLOPS_FORGE, new JigsawStructure(
                new Structure.StructureSettings(
